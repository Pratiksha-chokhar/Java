...
public class ArrayDemo {
	...
	public static void main(String[] args) {
		...
		//SEARCH
		boolean Available = list.contains("Android");
		System.out.println("Is list contains Android :: "+Available);
		boolean WebOs = list.contains("WebOS");
		System.out.println("Is list contains WebOS :: "+WebOs);
